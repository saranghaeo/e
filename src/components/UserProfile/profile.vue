<template>
    <div v-if="Authstore.user" class="content">
        <ProfileEditable v-if="playerData" :player="playerData" style="margin-bottom: 20px;" />
        <MouseBanner v-if="settingsData && settingsData.mouse_settings" :settings="settingsData.mouse_settings" style="margin-bottom: 20px;"/>
        <StartUpSettingBanner v-if="settingsData" :settings="settingsData" style="margin-bottom: 20px;"/>
        <CrosshairBanner v-if="settingsData" :settings="settingsData" style="margin-bottom: 20px;" />
    </div>
...
import CrosshairBanner from '@/components/UserProfile/CrosshairBanner.vue';
